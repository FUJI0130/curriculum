...
func (m *MockTagRepository) FindByNames(arg0 context.Context, arg1 []string) ([]*tagdm.Tag, error) {
	m.ctrl.T.Helper()
...
func (m *MockTagRepository) StoreWithTransaction(arg0 *sqlx.Tx, arg1 *tagdm.Tag) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "StoreWithTransaction", arg0, arg1)
	ret0, _ := ret[0].(error)
	return ret0
}

// StoreWithTransaction indicates an expected call of StoreWithTransaction.
func (mr *MockTagRepositoryMockRecorder) StoreWithTransaction(arg0, arg1 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "StoreWithTransaction", reflect.TypeOf((*MockTagRepository)(nil).StoreWithTransaction), arg0, arg1)
}
