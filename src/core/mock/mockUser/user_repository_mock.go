...
func (m *MockUserRepository) Store(arg0 context.Context, arg1 *userdm.User, arg2 []*userdm.Skill, arg3 []*userdm.Career) error {
	m.ctrl.T.Helper()
...
func (mr *MockUserRepositoryMockRecorder) Store(arg0, arg1, arg2, arg3 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Store", reflect.TypeOf((*MockUserRepository)(nil).Store), arg0, arg1, arg2, arg3)
}
