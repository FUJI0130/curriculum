...
func (m *MockUserRepository) StoreWithTransaction(arg0 *sqlx.Tx, arg1 *userdm.UserDomain) error {
	m.ctrl.T.Helper()
...
func (mr *MockUserRepositoryMockRecorder) StoreWithTransaction(arg0, arg1 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "StoreWithTransaction", reflect.TypeOf((*MockUserRepository)(nil).StoreWithTransaction), arg0, arg1)
}
